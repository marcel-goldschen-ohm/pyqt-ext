...
![test](https://github.com/marcel-goldschen-ohm/pyqt-ext/actions/workflows/test.yml/badge.svg)
...
- `pyqtgraph_ext/`
    - Various pyqtgraph objects with Matlab style formatting and custom user interaction.
- `utils/`
